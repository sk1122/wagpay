...
const footerNavigation = {
  ...
  social: [
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/sk1122_',
      style: 'h-6 w-6',
      icon: (props: any) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/sk1122/wagpay',
      style: 'h-6 w-6',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            ...
            <div className="flex space-x-6">
              {footerNavigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className={item.style + " text-gray-400 hover:text-gray-500"}
                >
                  <span className="sr-only">{item.name}</span>
                  <item.icon className="h-full w-full" aria-hidden="true" />
                </a>
              ))}
            </div>
          </div>
